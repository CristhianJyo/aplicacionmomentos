...
$$
\begin{align}
h(X) = & -\int_{0}^x{(\lambda \mbox{e}^{-\lambda x }) \log(\lambda \mbox{e}^{-\lambda x }) \, dx}

\\= & -(\lambda \mbox{e}^{-\lambda x }) \log(\lambda \mbox{e}^{-\lambda x }) \times \int_0^x{dx}

\\= & - (\lambda \mbox{e}^{-\lambda x }) \log(\lambda \mbox{e}^{-\lambda x }) \times x

\\= & - \lambda \mbox{e}^{-\lambda x } x( \log(\lambda)-\lambda x)

\end{align}
$$
Por lo tanto $h(\mathcal{U}(a,b)) = - \lambda \mbox{e}^{-\lambda x } x( \log(\lambda)-\lambda x)$
...
$$
\begin{align}
h(X) = & -\int_{-\infty}^\infty{(\frac{1}{2}\lambda \mbox{e}^{-\lambda |x|})} \log(\frac{1}{2}\lambda \mbox{e}^{-\lambda |x|}) \, dx

\\= & -(\frac{1}{2}\lambda \mbox{e}^{-\lambda |x|} \log(\frac{1}{2}\lambda \mbox{e}^{-\lambda |x|}) \times \int_{-\infty}^\infty

\\= & \frac{1}{\lambda} \log(\lambda)+\frac{1}{\lambda}

\\= & \frac{1+\log(\lambda)}{\lambda}

\end{align}
$$

Por lo tanto $h(\mathcal{U}(a,b)) =\frac{1+\log(\lambda)}{\lambda}$
...
$$
\begin{align}
h(X) = & -\int_{-\infty}^\infty{(\frac{1}{\sigma \sqrt{2 \pi}}\mbox{e}^{-(x-\mu)^2/2\sigma^2}) \log(\lambda \mbox{e}^{-\lambda x }) \, dx}

\\= & -(\frac{1}{\sigma \sqrt{2 \pi}}\mbox{e}^{-(x-\mu)^2/2\sigma^2}) \log(\lambda \mbox{e}^{-\lambda x }) \times \int_{-\infty}^\infty{dx}

\\= & -(\frac{1}{\sigma \sqrt{2 \pi}}\mbox{e}^{-(x-\mu)^2/2\sigma^2}) (\frac{(x-\mu)^2}{2\sigma^2}- \log(\frac{1}{\sigma \sqrt{2\pi}}) \,dx
...
Por lo tanto $h(\mathcal{U}(a,b)) =\frac{1}{2} (1+log(2 \pi \sigma^2 ))$
...
$$
\begin{align}
h(X) = & -\int_{-A}^A{(\frac{1}{A\sqrt{A^2-x^2}}) \log(\frac{1}{A\sqrt{A^2-x^2}}) \, dx}

\\= & -(\frac{1}{A\sqrt{A^2-x^2}}) \log(\frac{1}{A\sqrt{A^2-x^2}}) \times \int_{-A}^A{dx}

\\= & - \frac{1}{A\sqrt{A^2-x^2}} \log(\frac{1}{A\sqrt{A^2-x^2}}) \times 2A

\\= & \frac{2 \log(A \sqrt{A^2-x^2})}{\sqrt{A^2-x^2}}
\end{align}
$$

Por lo tanto $h(\mathcal{U}(a,b)) =\frac{2 \log(A \sqrt{A^2-x^2})}{\sqrt{A^2-x^2}}$
